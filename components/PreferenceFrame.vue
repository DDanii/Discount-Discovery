...
<template>
  <div class="w-64 min-h-fit border-2 rounded-xl border-green-600 m-2 flex flex-col overflow-hidden">
    ...
    <div class="flex place-content-around mt-auto">
      <button class="p-1 border-t-2 border-r border-green-600 w-full flex place-content-center"
        @click="$emit('preference-change', { value: preference ? null : true })">
        <IconTick :is-filled="preference === true" />
      </button>
      <button class="p-1 border-t-2 border-l border-green-600 w-full flex place-content-center"
