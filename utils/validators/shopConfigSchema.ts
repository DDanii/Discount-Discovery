...
import { z } from "zod";
import { type ShopConfig, type ParseStep, type ForEachParameters, type IfParameters, StepType } from "./../types/shopConfig";

export const stepTypeSchema = z.enum(StepType);
...
export const parseStepSchema: z.ZodSchema<ParseStep> = z.lazy(() => z.object({
    stepParameters: z.union([fetchParametersSchema, literalParametersSchema, setPropParametersSchema, parseJsonParametersSchema, forEachParametersSchema, createArrayParametersSchema, pushToArrayParametersSchema, parseHtmlParametersSchema, htmlQuerySelectorParametersSchema, concatParametersSchema, toStringParametersSchema, htmlCloneParametersSchema, deepCopyParametersSchema, sliceParametersSchema, splitParametersSchema, replaceParametersSchema, spreadParametersSchema, ifParametersSchema])
}));

export const forEachParametersSchema: z.ZodSchema<ForEachParameters> = z.lazy(() => z.object({
    method: z.literal(StepType.ForEach),
    source: z.string(),
    steps: z.array(parseStepSchema)
}));

export const ifParametersSchema: z.ZodSchema<IfParameters> = z.lazy(() => z.object({
